		...
		<div class="container py-lg-5">
			...
			<div class="welcome-grids row mt-5">
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('images/grid1.jpg')}}" class="img-fluid" alt="" />
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('images/grid3.jpg')}}" class="img-fluid" alt="" />
								<div class="boxhny-content">
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('images/grid2.jpg')}}" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('images/grid4.jpg')}}" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('images/grid5.jpg')}}" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="{{asset('images/grid6.jpg')}}" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
			...
			<div class="ecom-products-grids row mt-lg-5 mt-3">
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2 transmitv">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('images/shop-1.jpg')}}">
								<img class="pic-2 img-fluid" src="{{asset('images/shop-11.jpg')}}">
							</a>
							<ul class="social">
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('images/shop-2.jpg')}}">
								<img class="pic-2 img-fluid" src="{{asset('images/shop-22.jpg')}}">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('images/shop-3.jpg')}}">
								<img class="pic-2 img-fluid" src="{{asset('images/shop-33.jpg')}}">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('images/shop-4.jpg')}}">
								<img class="pic-2 img-fluid" src="{{asset('images/shop-44.jpg')}}">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('images/shop-5.jpg')}}">
								<img class="pic-2 img-fluid" src="{{asset('images/shop-55.jpg')}}">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('images/shop-6.jpg')}}">
								<img class="pic-2 img-fluid" src="{{asset('images/shop-66.jpg')}}">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('images/shop-7.jpg')}}">
								<img class="pic-2 img-fluid" src="{{asset('images/shop-77.jpg')}}">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="{{asset('images/shop-8.jpg')}}">
								<img class="pic-2 img-fluid" src="{{asset('images/shop-88.jpg')}}">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
		...
		<div class="container py-lg-5">
			...
			<div class="post-hny-grids row mt-5">
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<a href="#">
						<figure>
							<img class="img-fluid" src="{{asset('images/bg1.jpg')}}" alt="blog-image">
						</figure>
					</a>
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<a href="#">
						<figure>
							<img class="img-fluid" src="{{asset('images/bg2.jpg')}}" alt="blog-image">
						</figure>
					</a>
					<div class="blog-thumbhny-caption">
						<ul class="blog-info-list">
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<figure>
						<img class="img-fluid" src="{{asset('images/bg3.jpg')}}" alt="blog-image">
					</figure>
					<div class="blog-thumbhny-caption">
						<ul class="blog-info-list">
							<li><a href="#admin">By admin</a></li>
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<figure>
						<img class="img-fluid" src="{{asset('images/bg4.jpg')}}" alt="blog-image">
					</figure>
					<div class="blog-thumbhny-caption">
						<ul class="blog-info-list">
							<li><a href="#admin">By admin</a></li>
								...
								<div class="row">
									<div class="col-md-3">
										<div class="customer-info text-center">
											...
											<div class="feedback-review mt-4">
												<img src="{{asset('images/c1.jpg')}}" class="img-fluid" alt="">
												<h5>Smith Roy</h5>
									...
									<div class="col-md-3">
											<div class="customer-info text-center">
													...
													<div class="feedback-review mt-4">
														<img src="{{asset('images/c2.jpg')}}" class="img-fluid" alt="">
														<h5>Lora Grill</h5>
									...
									<div class="col-md-3">
											<div class="customer-info text-center">
													...
													<div class="feedback-review mt-4">
														<img src="{{asset('images/c3.jpg')}}" class="img-fluid" alt="">
														<h5>Laura Sten</h5>
									...
									<div class="col-md-3">
											<div class="customer-info text-center">
													...
													<div class="feedback-review mt-4">
														<img src="{{asset('images/c4.jpg')}}" class="img-fluid" alt="">
														<h5>John Lee</h5>

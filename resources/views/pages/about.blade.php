			...
			<div class="container py-lg-5">
					...
					<div class="row team-row mt-5">
						<div class="col-lg-4 col-sm-6 mb-lg-0 mb-4 team-wrapper position-relative">
							<a href="#"><img src="{{asset('images/team1.jpg')}}" class="team_member img-fluid" alt="Team Member"></a>
							...
							<div class="col-lg-4 col-sm-6 mb-lg-0 mb-4 team-wrapper position-relative">
								<a href="#"><img src="{{asset('images/team2.jpg')}}" class="team_member img-fluid" alt="Team Member"></a>
								<div class="team_info mt-3 position-absolute">
							...
							<div class="col-lg-4 col-sm-6 team-wrapper position-relative">
								<a href="#"><img src="{{asset('images/team3.jpg')}}" class="team_member img-fluid" alt="Team Member"></a>
								<div class="team_info mt-3 position-absolute">
